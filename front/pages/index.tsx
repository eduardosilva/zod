  ...
  return (
    <div className={styles['music-container']}>
        ...
        <div className={styles['navigation']}>
          <button id="prev" className={styles['action-btn']}>
            <i className={styles['fas fa-backward']}></i>
          </button>
          <button id="play" className={styles['action-btn action-btn-big']}>
            <i className="fas fa-play"></i>
          </button>
          <button id="next" className={styles['action-btn']}>
      ...
      <div className={styles.controls}>
        <button className={styles["play-pause"]} onClick={togglePlay}>{isPlaying ? 'Pause' : 'Play'}</button>
        {error && <p>{error}</p>}
        {currentChord && <p className={styles.chord}>{currentChord}</p>}
      </div> */}
    </div>
  );
}
